...
static gboolean a(void *view)
{
  gfloat scale = 1.0;
  clutter_actor_animate (view, CLUTTER_LINEAR, 600,
               "x0", (int)(X0*scale),
               "y0", (int)(Y0*scale),
               "scale", scale, NULL);
  return TRUE;
...
main (int argc, char **argv)
{
  ...
  g_timeout_add (500, a, geglview);
  g_timeout_add (1000, b, geglview);
  g_timeout_add (1300, c, geglview);
  clutter_main();
